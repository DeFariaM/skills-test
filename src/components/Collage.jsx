    ...
    >
      ...
      >
        <div className="mx-auto grid w-full grid-cols-1 gap-4  md:w-fit md:grid-cols-2 md:items-end">
          <div className="flex h-[200px] items-center justify-center overflow-hidden md:max-h-[160px] md:max-w-[160px]">
            <img
          ...
          <div className="flex h-[200px] items-center justify-center overflow-hidden md:h-[240px] md:w-[160px]">
            <img
              ...
              alt=""
              className="mt-56 md:mt-0"
            />
          </div>
        </div>
        <div className="mx-auto grid w-full grid-cols-1 gap-3 md:w-fit md:grid-cols-3">
          <div className=" flex h-[200px] items-center justify-center overflow-hidden md:h-[128px] md:w-[192px] md:items-start">
            <img
          ...
          <div className="flex h-[200px] items-center overflow-hidden md:mx-auto md:h-[240px] md:w-[160px] md:items-start">
            <img
          ...
          <div className="mx-auto flex h-[200px]  items-center justify-center overflow-hidden md:h-[128px] md:w-[192px] md:items-start">
            <img
