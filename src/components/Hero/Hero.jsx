    ...
    <section id="hero" className=" h-fit">
      <div className=" h-[500px] w-full justify-center space-y-10 bg-brand-bg py-10 text-center md:h-[620px] md:rounded-3xl">
        <div className="space-y-6 md:mt-12">
          <h1 className="justify-center text-4xl font-semibold leading-snug text-brand-primary md:text-7xl">
            Grow your users.
            <br />
        ...
        <div
          id="graphics"
          className="mx-auto flex w-[80%] flex-col space-y-5 text-left md:w-fit md:flex-row md:space-x-4 md:space-y-0"
        >
          <div className="flex flex-col space-y-2">
            <div className="relative">
              <input
                ...
                className="relative h-fit w-[100%] rounded-md p-2 font-inter ring-inset  focus:border-transparent focus:ring-0 md:w-[30vw]"
              />
              <span
