    ...
    <div>
      ...
      >
        ...
        <path
          ...
          stroke-miterlimit="10"
        />
        <g filter="url(#filter0_ii_202_4799)">
          <path
            d="M10.436 7.53833C10.145 7.84633 9.97299 8.32433 9.97299 8.94333V31.0593C9.97299 31.6793 10.145 32.1563 10.436 32.4643L10.51 32.5363L22.899 20.1473V20.0013V19.8553L10.51 7.46533L10.436 7.53833Z"
            fill="url(#paint0_linear_202_4799)"
          />
          <path
            d="M27.028 24.2781L22.899 20.1471V20.0011V19.8551L27.029 15.7251L27.122 15.7781L32.015 18.5581C33.412 19.3521 33.412 20.6511 32.015 21.4461L27.122 24.2261L27.028 24.2781Z"
            fill="url(#paint1_linear_202_4799)"
          />
          <g filter="url(#filter1_i_202_4799)">
            <path
              d="M27.122 24.225L22.898 20.001L10.436 32.464C10.896 32.952 11.657 33.012 12.514 32.526L27.122 24.225Z"
              fill="url(#paint2_linear_202_4799)"
            />
          </g>
          <path
            d="M27.122 15.7772L12.514 7.47719C11.657 6.99019 10.896 7.05119 10.436 7.53919L22.899 20.0022L27.122 15.7772Z"
            fill="url(#paint3_linear_202_4799)"
          />
        </g>
        <defs>
          <filter
            id="filter0_ii_202_4799"
            x="9.97299"
            y="7.14111"
            width="23.0898"
            height="25.7207"
          ...
          >
            ...
            <feBlend
              mode="normal"
              in2="shape"
              result="effect1_innerShadow_202_4799"
            />
            <feColorMatrix
              in="SourceAlpha"
              type="matrix"
            ...
            <feBlend
              mode="normal"
              in2="effect1_innerShadow_202_4799"
              result="effect2_innerShadow_202_4799"
            />
          </filter>
          <filter
            id="filter1_i_202_4799"
            x="10.436"
            y="20.001"
            width="16.686"
            height="12.8608"
